...
window.onload = function() {
    setTimeout(removeBlur, 10000); // set timer to remove blur effect after 20 seconds
  };
  
  function removeBlur() {
    document.body.style.filter = "none"; // remove blur effect by setting the filter to "none"
